...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1259<!--/n-->` tests across <!--n:unit-suites-->283<!--/n--> suites, including the <!--n:render-tests-->380<!--/n--> React render tests via `jsdom` + `esbuild`)

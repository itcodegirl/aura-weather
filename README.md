...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->759<!--/n-->` tests across <!--n:unit-suites-->172<!--/n--> suites, including the <!--n:render-tests-->296<!--/n--> React render tests via `jsdom` + `esbuild`)

...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->781<!--/n-->` tests across <!--n:unit-suites-->175<!--/n--> suites, including the <!--n:render-tests-->305<!--/n--> React render tests via `jsdom` + `esbuild`)
...
- **Unit (`numbers.test.mjs`, <!--n:numbers-tests-->10<!--/n--> tests)** — `toFiniteNumber` rejects
  ...
  `NaN`/`Infinity`.
- **Integration (`transforms.test.mjs`, <!--n:transforms-tests-->12<!--/n--> tests)** —

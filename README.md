...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->914<!--/n-->` tests across <!--n:unit-suites-->210<!--/n--> suites, including the <!--n:render-tests-->316<!--/n--> React render tests via `jsdom` + `esbuild`)

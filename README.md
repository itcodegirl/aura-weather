...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1156<!--/n-->` tests across <!--n:unit-suites-->260<!--/n--> suites, including the <!--n:render-tests-->371<!--/n--> React render tests via `jsdom` + `esbuild`)

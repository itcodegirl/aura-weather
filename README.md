...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1249<!--/n-->` tests across <!--n:unit-suites-->278<!--/n--> suites, including the <!--n:render-tests-->377<!--/n--> React render tests via `jsdom` + `esbuild`)

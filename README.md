...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->940<!--/n-->` tests across <!--n:unit-suites-->220<!--/n--> suites, including the <!--n:render-tests-->320<!--/n--> React render tests via `jsdom` + `esbuild`)

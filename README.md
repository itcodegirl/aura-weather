...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->863<!--/n-->` tests across <!--n:unit-suites-->190<!--/n--> suites, including the <!--n:render-tests-->314<!--/n--> React render tests via `jsdom` + `esbuild`)

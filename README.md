...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->977<!--/n-->` tests across <!--n:unit-suites-->230<!--/n--> suites, including the <!--n:render-tests-->325<!--/n--> React render tests via `jsdom` + `esbuild`)

...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1222<!--/n-->` tests across <!--n:unit-suites-->272<!--/n--> suites, including the <!--n:render-tests-->371<!--/n--> React render tests via `jsdom` + `esbuild`)

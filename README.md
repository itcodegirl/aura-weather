...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1000<!--/n-->` tests across <!--n:unit-suites-->234<!--/n--> suites, including the <!--n:render-tests-->334<!--/n--> React render tests via `jsdom` + `esbuild`)

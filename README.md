...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1257<!--/n-->` tests across <!--n:unit-suites-->281<!--/n--> suites, including the <!--n:render-tests-->379<!--/n--> React render tests via `jsdom` + `esbuild`)

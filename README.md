...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->755<!--/n-->` tests across <!--n:unit-suites-->171<!--/n--> suites, including the <!--n:render-tests-->291<!--/n--> React render tests via `jsdom` + `esbuild`)

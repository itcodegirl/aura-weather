...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->783<!--/n-->` tests across <!--n:unit-suites-->175<!--/n--> suites, including the <!--n:render-tests-->305<!--/n--> React render tests via `jsdom` + `esbuild`)

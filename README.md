...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1251<!--/n-->` tests across <!--n:unit-suites-->279<!--/n--> suites, including the <!--n:render-tests-->378<!--/n--> React render tests via `jsdom` + `esbuild`)

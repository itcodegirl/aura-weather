...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->766<!--/n-->` tests across <!--n:unit-suites-->173<!--/n--> suites, including the <!--n:render-tests-->303<!--/n--> React render tests via `jsdom` + `esbuild`)

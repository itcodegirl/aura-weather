...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->883<!--/n-->` tests across <!--n:unit-suites-->196<!--/n--> suites, including the <!--n:render-tests-->316<!--/n--> React render tests via `jsdom` + `esbuild`)

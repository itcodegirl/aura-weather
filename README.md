...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1236<!--/n-->` tests across <!--n:unit-suites-->275<!--/n--> suites, including the <!--n:render-tests-->377<!--/n--> React render tests via `jsdom` + `esbuild`)

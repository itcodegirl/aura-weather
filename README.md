...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1054<!--/n-->` tests across <!--n:unit-suites-->247<!--/n--> suites, including the <!--n:render-tests-->352<!--/n--> React render tests via `jsdom` + `esbuild`)

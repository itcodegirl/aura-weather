...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->751<!--/n-->` tests across <!--n:unit-suites-->170<!--/n--> suites, including the <!--n:render-tests-->291<!--/n--> React render tests via `jsdom` + `esbuild`)

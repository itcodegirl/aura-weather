...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->1108<!--/n-->` tests across <!--n:unit-suites-->253<!--/n--> suites, including the <!--n:render-tests-->360<!--/n--> React render tests via `jsdom` + `esbuild`)

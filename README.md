...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->952<!--/n-->` tests across <!--n:unit-suites-->221<!--/n--> suites, including the <!--n:render-tests-->322<!--/n--> React render tests via `jsdom` + `esbuild`)

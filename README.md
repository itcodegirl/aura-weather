...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->816<!--/n-->` tests across <!--n:unit-suites-->179<!--/n--> suites, including the <!--n:render-tests-->308<!--/n--> React render tests via `jsdom` + `esbuild`)

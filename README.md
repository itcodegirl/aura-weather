...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->739<!--/n-->` tests across <!--n:unit-suites-->168<!--/n--> suites, including the <!--n:render-tests-->289<!--/n--> React render tests via `jsdom` + `esbuild`)

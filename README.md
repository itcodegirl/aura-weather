...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->728<!--/n-->` tests across <!--n:unit-suites-->164<!--/n--> suites, including the <!--n:render-tests-->289<!--/n--> React render tests via `jsdom` + `esbuild`)

...
- `npm run lint` passes
- `npm test` passes (`<!--n:unit-tests-->801<!--/n-->` tests across <!--n:unit-suites-->177<!--/n--> suites, including the <!--n:render-tests-->308<!--/n--> React render tests via `jsdom` + `esbuild`)
